...
struct AboutSafeMealView: View {
    var body: some View {
        ProfileSecondaryPage(
            title: SafeMealL10n.text(L10nKey.Profile.About.title),
            subtitle: SafeMealL10n.text(L10nKey.Profile.About.subtitle)
        ) {
            ProfileSectionBlock(title: SafeMealL10n.text(L10nKey.Profile.About.disclosureSection)) {
                ...
                NavigationLink(value: ProfileRoute.certificate) {
                    ProfileNavigationRow(
                        ...
                        title: SafeMealL10n.text(L10nKey.Profile.About.certificate)
                    )
                }
                .buttonStyle(.plain)
            }
            ...
            VStack(spacing: 4) {
                ...
                Text(SafeMealL10n.text(L10nKey.Profile.About.copyright))
                    .font(SafeMealFont.custom(11, relativeTo: .caption2))
                    .foregroundStyle(Color.gray.opacity(0.6))
            }
