...
struct AdRewardResultSheet: View {
    ...
    private var iconName: String {
        ...
        case .claimFailed, .loadFailed: return "exclamationmark.triangle.fill"
        }
    }

    private var iconColor: Color {
        switch resultType {
        case .success: return SafeEatTheme.primary
        case .claimFailed, .loadFailed: return SafeEatTheme.warning
        }
    }
    ...
    private var buttonTitle: String {
        switch resultType {
        case .success: return SafeEatL10n.text(L10nKey.Common.ok)
        case .claimFailed, .loadFailed: return SafeEatL10n.text(L10nKey.Home.adRewardRetry)
        }
    }
    ...
    private var iconView: some View {
        ZStack {
            Circle()
                .fill(iconColor.opacity(colorScheme == .dark ? 0.16 : 0.14))
        ...
        .shadow(color: iconColor.opacity(0.14), radius: 18, y: 8)
    }
