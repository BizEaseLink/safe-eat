...
enum L10nKey {
    ...
    enum Auth {
        ...
        static let loginPromptGoLogin = "auth.login_prompt.go_login"
        static let loginPromptAccountTitle = "auth.login_prompt.account_title"
        ...
        static let contactSupport = "auth.contact_support"
        static let accountDeletingTitle = "auth.account_deleting.title"
        static let accountDeletingMessage = "auth.account_deleting.message"
        static let accountDeletingRecover = "auth.account_deleting.recover"
        static let accountLockedTitle = "auth.account_locked.title"
        static let accountLockedMessage = "auth.account_locked.message"
        static let loginWithSms = "auth.login_with_sms"
        static let accountRecoveryTitle = "auth.account_recovery.title"
        static let accountRecoverySubtitle = "auth.account_recovery.subtitle"
        static let accountRecoveryAction = "auth.account_recovery.action"
        static let accountRecoverySuccess = "auth.account_recovery.success"
        static let contactXhs = "auth.contact.xhs"
    ...
    enum Membership {
        ...
        static let confirmAutoRenewal = "membership.purchase.confirm_auto_renewal"
        static let confirmCancelPath = "membership.purchase.confirm_cancel_path"
        static let confirmTrialInfo = "membership.purchase.confirm_trial_info"
    ...
    enum Result {
        ...
        static let dietBuddhistStrict = "result.diet.buddhist_strict"
